...
void main() {
  /// Both roots, resolved whether the test runs from `packages/bladewatch_rpc/` or the repo
  ...
  (Directory, Directory)? locate() {
    for (final (dart, java) in [
      ...
      ('packages/bladewatch_rpc/lib/rpc/services', 'app/src/main/java/com/loabletech/bladewatch/server/connect'),
    ]) {
